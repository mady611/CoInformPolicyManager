...
!function(t) {
    ...
    var i = {
        ...
        _ehAddBtn: function() {
            this.option.validate && !this.option.validate() || (this._addNewArea(),
            $(this.elem).find(this.option.area_del).show(),
            this.option.maximum > 0 && $(this.elem).find(this.option.area_var).length >= this.option.maximum && $(this.option.btn_add).hide(),
            "function" == typeof this.option.after_add && this.option.after_add())
        },
        ...
        _initFieldVal: function(t) {
            return "false" != $(t).attr("empty_val") && "false" != $(t).attr("data-empty-val") && ("checkbox" == $(t).attr("type") || "radio" == $(t).attr("type") ? t.checked = !1 : "SELECT" != $(t).prop("tagName") && "submit" != $(t).attr("type") && "reset" != $(t).attr("type") && "image" != $(t).attr("type") && "button" != $(t).attr("type") && $(t).val(""),
            !0)
        },
